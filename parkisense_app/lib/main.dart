...
import 'package:parkisense_app/presentation/screens/doctor/doctor_patient_recordings_screen.dart';

import 'package:parkisense_app/presentation/screens/chat/user_chat_screen.dart';

import 'package:parkisense_app/presentation/screens/chat/doctor_chat_list_screen.dart';

import 'package:parkisense_app/presentation/screens/chat/doctor_chat_screen.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        if (settings.name == '/doctor-patient-recordings') {

          final args = settings.arguments as Map<String, dynamic>?;

          return MaterialPageRoute(

            builder: (context) => DoctorPatientRecordingsScreen(
              patientId: args?['patientId'] as String? ?? '',
              patientName: args?['patientName'] as String? ?? 'Unknown Patient',
            ),
        ...
        if (settings.name == '/doctor-chat') {
          ...
          return MaterialPageRoute(
            builder: (context) => DoctorChatScreen(
              ...
              userName: args?['userName'] as String? ?? 'Unknown Patient',
            ),
          );
        }
